...
class TestSensor(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.sensor = Sensor(avg_visit_count, std_visit_count, malfunction_chance, break_chance)
    ...
    def test_closed_on_sunday(self)->None:
        ...
        self.assertTrue( -1 == self.sensor.simulate_visit_count(sunday_date),
    ...
    def test_opened_on_worked_days(self):
        ...
        for weekday_date in weekday_list:
            self.assertTrue( -1 != self.sensor.simulate_visit_count(weekday_date),
    ...
    def test_malfunction_day(self)->None:
        ...
        self.assertTrue( 401 == self.sensor.simulate_visit_count(malfunction_date),
    ...
    def test_break_day(self)->None:
        ...
        self.assertTrue( 0 == self.sensor.simulate_visit_count(break_date),
